  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', bottom: '16px', left: '16px', right: '16px', transform: hovered ? 'translateY(-3px)' : 'translateY(0)', transition: TRANSITION.mid }}>
        <div style={{ fontFamily: FONTS.display, fontWeight: 700, fontSize: '15px', color: '#FFFFFF',background: "linear-gradient( to ,top, rgba(0,0,0,0.65), rgba(0,0,0,0.15), transparent)", marginBottom: '3px' }}>{category.name}</div>
        <div style={{ fontSize: '12px', color: '#FFFFFF',background: "linear-gradient( to top, rgba(0,0,0,0.65), rgba(0,0,0,0.15), transparent)"}}>{category.product_count || 0} products</div>
      </div> 
